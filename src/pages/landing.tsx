            ...
            <div className="bg-cream1 font-mhs pt-24">
                ...
                <div className="text-2xl md:px-16 xl:px-24 xl:text-3xl pb-8">
                    <div className="grid grid-cols-2 md:mt-8 xl:mt-16">
                        <div className="md:mr-4 xl:mr-20 md:p-6 border-8 border-brown2 bg-tan2 text-beige1 w-fill">
                        ...
                        <div className="md:ml-4 xl:ml-20 md:p-6 border-8 border-brown2 bg-tan2 text-beige1 w-fill">
                            <div>
                                {/* Location */}
