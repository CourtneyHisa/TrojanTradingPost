            ...
            <div className="text-2xl md:px-16 xl:px-24 xl:text-3xl bg-gray-100">
                ...
                <div className="grid grid-cols-2 md:mt-8 xl:mt-16">
                    <div className="md:mr-4 xl:mr-24 md:p-6 rounded-lg border-4 border-yellow-400 bg-yellow-900 text-white">
                        ...
                        <input className="font-bold underline w-full text-2xl xl:text-4xl pb-4 text-center" placeholder="What is the Trojan Trading Post?"></input>
                        <input className="text-wrap w-full h-full" placeholder="The Trojan Trading Post, or TTP for short, is a student-led pop-up shop that features different products created by students within the various Career and Technical Education pathways. We aim to foster Mililani school spirit and pride"></input>
                    </div>




                    <div className="text-center w-full h-full md:ml-4 md:p-6 rounded-lg border-4 border-yellow-400 bg-yellow-900 text-white">
                        <div>
                            {/* Location */}
