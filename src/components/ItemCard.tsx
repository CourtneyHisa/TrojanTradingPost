                        ...
                        <div className=" ">
                            <div className="card card-compact w-full h-full bg-base-100 shadow-xl col-span-1 sm:flex-wrap">
                                ...
                                <div className="flex items-center justify-center p-4">
                                    <img src={item.itemImage} className="rounded-xl object-cover h-48 w-64" />
                                </div>
                                {/* Item Name */}
                                <h2 className="items-center text-center">{item.itemName}</h2>
                                ...
                                <div className="flex items-center justify-center">
                                {/* Price tag */}
                                <div className="flex-1">${item.itemPrice}</div>
