...
export default function Footer() {
    return (
        <div>
            <footer className="relative footer p-10 bg-gray-300 object-bottom z-1">
                ...
                <nav>
                    <h6 className="footer-title">Mililani High School</h6>
                    <a className="link link-hover">95-1200 Meheula Parkway,</a>
                    <a className="link link-hover">Mililani, HI 96789</a>
                    <a className="link link-hover">Phone: (808) 307-4200</a>
                    <a className="link link-hover">Fax: (808) 627-7375 </a>
                </nav>
                <nav>
